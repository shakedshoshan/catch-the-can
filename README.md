...
A simple Phaser 3 game where you control a cart to catch falling stars. The goal is to catch as many stars as possible within 60 seconds.

## How to Play

1. Use the left and right arrow keys to move the cart
2. Catch the falling stars with your cart
3. Each star caught gives you 10 points
4. Try to get the highest score within 60 seconds

## Development

This game is built using Phaser 3, React, and TypeScript.
...
This game was created using the [Phaser 3 React TypeScript template](https://github.com/phaserjs/template-react-ts).
